...
const Orders = (props) => {
    ...
    const update_status_database=async(id,status_data)=>{
        ...
        try {
          ...
          const response = await axios.put(`http://127.0.0.1:8000/update_status/${id}`, updated_data, { headers });
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            ...
            const response = await axios.get('http://127.0.0.1:8000/all_order', { headers });
            ;
      ...
      const handleOrderDelete = async (id) => {
        try {
          ...
          const response = await axios.get(`http://127.0.0.1:8000/delete_order/${id}`, { headers });
